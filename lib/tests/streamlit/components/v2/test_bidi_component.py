...
class BidiComponentTest(DeltaGeneratorTestCase):
    ...
    def test_component_with_js_content_only(self):
        ...
        # Call the component
        result = st._bidi_component("js_only_component")
    ...
    def test_component_with_html_content_only(self):
        ...
        # Call the component
        result = st._bidi_component("html_only_component")
    ...
    def test_component_with_js_url_only(self):
        ...
        with patch.object(
            ...
            # Call the component
            result = st._bidi_component("js_url_component")
    ...
    def test_component_with_both_js_and_html(self):
        ...
        # Call the component
        result = st._bidi_component("full_component")
